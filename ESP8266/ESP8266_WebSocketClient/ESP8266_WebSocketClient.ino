...
const char* ssid     = "ACME"; //enter your ssid/ wi-fi(case sensitiv) router name - 2.4 Ghz only
const char* password = "11223344556677889900aabbcc";     // enter ssid password (case sensitiv)
char host[] = "alexaskillsacmeiot.herokuapp.com"; //enter your Heroku domain name like "espiot.herokuapp.com" 
